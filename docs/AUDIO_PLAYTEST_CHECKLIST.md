...
|---|---|---|---|
| ch01_001 | Low rain-night BGM, quiet room ambience, soft rain on window | No narration reading, no harsh white noise | pending manual listen |
| ch01_003 | Phone screen wake, table vibration, dead-call ring, rain ambience | Phone call must not sound like a game ring or cheerful coin cue | pending manual listen |
...
| ch01_007 | Doorbell, wet corridor step, Xuzhiwan low breath | Doorbell must not sound like a game prompt | pending manual listen |
| ch01_008 | Door chain and corridor light flicker | Door chain must not sound like a coin or bright metal reward | pending manual listen |
...
| ch04_010 | Photo zoom and soft choice confirm | Photo zoom must not sound like a UI game button | pending manual listen |
...
| ch06_020 | Ending archive BGM, room ambience, archive stamp | Ending must not sound like completion music | pending manual listen |
