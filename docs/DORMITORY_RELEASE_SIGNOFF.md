# Dormitory Rules Story Release Sign-off

Status: `not started`. Enter factual results only. Blank, failed, or inconclusive rows keep the Draft PR blocked.

## Device Matrix

| Date | Tester | Device / Browser | Build SHA | Pass / Fail | Notes |
|---|---|---|---|---|---|
|  |  | iPhone Safari |  |  |  |
|  |  | Android Chrome |  |  |  |
...
| Scenario | Device | Result | Evidence / notes | Tester | Date |
|---|---|---|---|---|---|
| Rain Call: advance and save to slot 1 |  |  |  |  |  |
| Dormitory: advance and save to slot 1 |  |  |  |  |  |
| Return to Rain Call and load its slot 1 |  |  |  |  |  |
| Return to Dormitory and load its slot 1 |  |  |  |  |  |
| Restart Rain Call without changing Dormitory state |  |  |  |  |  |
