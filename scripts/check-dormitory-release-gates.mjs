...
if (production.broadcastVoiceStatus !== "volcengine-generated-awaiting-listening-signoff" && production.broadcastVoiceStatus !== "volcengine-generated-ready") {
  failures.push("Formal dormitory broadcasts must be generated through the authorised Volcengine delivery pipeline before release.");
}
