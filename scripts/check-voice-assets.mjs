...
console.log(`Voice asset check passed. entries=${expected.length}; nodeVoices=${Object.values(story.nodes).filter((node) => node.text && node.type !== "choice").length}; broadcastCues=${contract.cues.length}; endings=${Object.keys(story.endings).length}`);
