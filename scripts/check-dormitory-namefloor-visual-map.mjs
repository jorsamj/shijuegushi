...
const isPartialEndingPhase = runtimeEndingIds.length > 0 && runtimeEndingIds.length < 8;

assert(runtimeSceneIds.length > 0, "No runtime scene IDs were discovered.");
assert(runtimeEndingIds.length === 0 || runtimeEndingIds.length === 4 || runtimeEndingIds.length === 8, `Expected current Draft phase, first-four phase, or eight canonical endings; found ${runtimeEndingIds.length}.`);
...
if (isDraftPhase || isPartialEndingPhase) {
