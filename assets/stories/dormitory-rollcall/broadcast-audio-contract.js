(function () {
  ...
  window.DORMITORY_BROADCAST_AUDIO_CONTRACT = {
    ...
    cues: [
      cue("dorm_broadcast_rollcall_start", ["dorm_chapter_01"], ["dorm_01_002"], "现在时间零点十七分。四一七寝室夜间点名开始。", "平静、制度化", 4, "Fade out within 120ms when leaving the node or beginning the rules."),
      cue("dorm_broadcast_public_rules", ["dorm_chapter_01"], ["dorm_01_002"], "一，点名结束前不得离开宿舍。二，真正的查寝者会敲三下，停两秒，再敲一下。三，床号被叫到时，当事人保持安静，由另一人回答：已经休息。四，红灯亮起时闭眼十秒，不得使用手机照明。五，有人从洗手间回来时，先查看她原来的床位。六，镜中出现陌生姓名时，不得擦去，也不得念出。", "清晰、匀速、无情绪", 34, "Stop and fade within 180ms on node exit; never overlap another broadcast cue."),
