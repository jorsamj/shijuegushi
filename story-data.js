window.MIST_DATA = (() => {
  ...
  add(1, 3, { speaker: "旁白", text: "手机突然震动。来电显示跳出来的名字，让林舟的手停在键盘上。\n\n许知夏。", scene: "phone_call_ui", type: "clue", gainClues: ["clue_dead_call"] });
  add(1, 4, { speaker: "林舟", text: "不可能。", scene: "phone_call_ui" });
  add(1, 5, { speaker: "许知夏的声音", text: "别开门，她不是我。", scene: "phone_call_ui" });
  add(1, 6, {
    type: "choice",
    scene: "phone_call_ui",
    speaker: "旁白",
  ...
  add(1, 7, { speaker: "女人", text: "林舟？我是许知晚。许知夏的妹妹。雨太大了，你先别怕。", scene: "corridor_door" });
  add(1, 8, { speaker: "旁白", text: "猫眼外站着一个浑身湿透的女人。她抬头时，林舟差点后退。\n\n那张脸和许知夏太像了。", scene: "corridor_door" });
  ...
  add(2, 3, { speaker: "许知晚", text: "因为三年前，他也是这样先让所有人闭嘴。", scene: "corridor_door" });
  add(2, 4, {
    type: "choice",
    scene: "corridor_door",
    speaker: "旁白",
  ...
  add(2, 15, { speaker: "周屿", text: "我只是担心你。你以前就容易心软，知夏出事那晚也是。", scene: "phone_call_ui" });
  ...
  add(3, 11, { speaker: "周屿", text: "知夏那时候压力很大，你现在翻这些，只会让所有人更难堪。", scene: "phone_call_ui" });
  ...
  add(3, 18, { speaker: "周屿", text: "我离开是因为受不了。林舟，不是每个人都能像你一样假装三年没事。", scene: "phone_call_ui", type: "clue", gainClues: ["clue_zhou_left"], setFlags: ["suspected_zhou"] });
  ...
  add(4, 18, { speaker: "周屿", text: "你没找到就好。我的意思是，别再翻那些东西了。它们只会害你。", scene: "phone_call_ui" });
  add(4, 19, { speaker: "陈妍", text: "照片收到了。我也看见右下角了。林舟，这不是你一个人能扛的事。", scene: "old_chat_memory" });
  add(4, 20, { speaker: "周屿", text: "林舟，你刚刚找到那张合照，对吗？", scene: "phone_call_ui", nextNodeId: "ch05_001" });
  ...
  add(5, 5, { speaker: "许知夏的声音", text: "如果这段被恢复，说明我没来得及见到林舟。", scene: "old_phone_view" });
  add(5, 6, { speaker: "陈妍", text: "可能。旧手机开机、云端恢复、定时提醒叠在一起，会像一次主动来电。吓人，但不是鬼。", scene: "old_chat_memory" });
  add(5, 7, { speaker: "周屿", text: "旧手机？她妹妹连这个都告诉你了？林舟，你知道她这些年怎么查你的吗？", scene: "phone_call_ui" });
  ...
  add(5, 11, { speaker: "许知夏的声音", text: "周屿他……如果我出事，不要相信他说那晚不在。照片——", scene: "old_phone_view" });
  ...
  add(5, 15, { speaker: "旁白", text: "录屏最后弹出恢复记录：旧手机开机后，三年前的语音备忘被云端提醒触发。死者来电终于有了现实解释。", scene: "old_phone_view", type: "clue", gainClues: ["clue_timed_voice"], setFlags: ["understood_dead_call"] });
  add(5, 16, { speaker: "周屿", text: "林舟，你听到录音了？", scene: "phone_call_ui" });
  add(5, 17, {
    type: "choice",
    scene: "phone_call_ui",
    speaker: "旁白",
  ...
  add(5, 18, { speaker: "周屿", text: "损坏就别修了。知夏已经死了，别再让她把活人也拖下去。", scene: "phone_call_ui" });
  add(5, 19, { speaker: "周屿", text: "你以为你在救她？你当年要是接她电话，她也许根本不会死。", scene: "phone_call_ui" });
  ...
  add(6, 20, { speaker: "旁白", text: "雨声退到窗外。所有选择，都开始结算。", scene: "ending_screen", resolveEnding: true, nextNodeId: null });
